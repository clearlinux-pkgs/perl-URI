...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/URI-5.11.tar.gz
...
cp %{_builddir}/URI-5.11/LICENSE %{buildroot}/usr/share/package-licenses/perl-URI/1901d391230618a9285903a4c6442ebf9affa678
if test -f Makefile.PL; then
