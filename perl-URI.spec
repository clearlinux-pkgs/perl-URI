...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/URI-5.32.tar.gz
...
%prep
%setup -q -n URI-5.32
cd %{_builddir}/URI-5.32
pushd ..
cp -a URI-5.32 buildavx2
popd
...
/usr/share/man/man3/URI::otpauth.3
/usr/share/man/man3/URI::smb.3
